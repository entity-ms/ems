...
function EntityMS(filename) {
  ...
  _commands.register('register', require('./Commands/Register'));
  _commands.register('unregister', require('./Commands/Unregister'));
}
 ...
 * @todo
 */
EntityMS.prototype.register = function (type, name, host, ip) {
  'use strict';
 ...
 * @todo
 */
EntityMS.prototype.unregister = function (type, name) {
  'use strict';
