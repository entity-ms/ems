  ...
  return function (req, res, next) {
    ...
    res.send({
      ...
      response: {
        ...
        type: central.components._instances[req.params.name].type,
        clsType: central.components._instances[req.params.name].instance.type,
        version: central.components._instances[req.params.name].version
      }
    });
  };
}
