...
function onInstancesHelp() {
  ...
  console.log('');
  console.log('    $ ems instances [list]');
  console.log('    $ ems instances create example-1 --type ems-simple-example');
  console.log('    $ ems instances info example-1');
  console.log('    $ ems instances remove example-1');
  console.log('    $ ems instances start example-1');
  console.log('    $ ems instances stop example-1');
  console.log('    $ ems instances restart example-1');
  console.log('    $ ems instances status example-1');
}
